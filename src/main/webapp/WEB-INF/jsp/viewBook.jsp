...
<body>
	...
	<div class="header3">
		...
		<div class="h3_right">
			...
			<div class="tsc">
				<a href="user/addShopCar?id=${book.id}&num=1">去购物车结算</a> <span class="sj_right"></span>
			</div>
		</div>
	</div>
	<!--头部导航-->
		...
		<div class="cn5_top">
			...
			<div class="cn5_top_y center01">
				...
				<div class="cn5topy_2">
					...
					<form action="user/addShopCar" id="addCar">
						<div class="pro_buy">
							...
							<div class="pro_addshop">
								<input type="submit" value="加入购物车"></a>
							</div>
						</div>
					</form>
					<div class="pro_ship">
	...
	<div class="footer3">
		...
		<div class="f3_middle">
			<ul class="f3_center">
				...
				<li class="f3_mi_li06">
					<h1>客服中心</h1> <img src="${book.image}" width="80px"
					height="80px">
					<p>抢红包、疑问咨询、优惠活动</p>
				</li>
			</ul>
