        ...
        <table>
            ...
            <c:forEach items="${orderlist}" var="orderForm">
                <tr>
                    ...
                    <td><input type="button" value="删除" onclick="javascript:window.location='user/toDeleteOrderForm?shopAddId=${orderForm.id}';"><input type="button" value="明细" onclick="javascript:window.location='user/toOrderDetail?orderFormId=${orderForm.id}';">  </td>
                </tr>
            </c:forEach>
