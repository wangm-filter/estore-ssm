    ...
    <div class="mainCenter">
        ...
        <div class="mainPro">
            ...
            <form>
                <table>
                    <tbody>
            <c:forEach items="${shopCar.orderLines}" var="entry" varStatus="state">
                        <tr>
                            <td class="index">${state.index + 1}</td>
                            <td>
                                <img src="${entry.value.book.image}" >
                                 <span>
 ...
 -->
             <!-- <div class="bb">
                ...
                <div class="allButtom">
                    ...
                    <span>已选择<font>${shopCar.sumNum}</font>件商品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总价(不含运费)：<font>¥${shopCar.cost}元</font></span>
                </div>
