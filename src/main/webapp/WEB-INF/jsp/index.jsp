...
<body>
	...
	<div class="header3">
		...
		<div class="h3_right">
			...
			<div class="tsc">
				<a href="user/addShopCar">去购物车结算</a> <span class="sj_right"></span>
			</div>
		</div>
	</div>
	<!--头部导航-->
						...
						<dd>
							...
							<p>
								<c:forEach items="${category.categories}" var="secondCategory">
									<a href="toList?id=${secondCategory.id}">${secondCategory.name}</a>
								</c:forEach>
							</p>
						</dd>
					</c:forEach>
			...
			<div class="c3_b1_center">
				...
				<div class="c3_b1_c_bottom">
					...
					<c:forEach items="${booklist}" var="book">
						...
						<img  width="100px"  height="100px" src="${book.image}" /></a>
						<a href="viewBook?id=${book.id}">${book.name}</a>
						</li>
					</c:forEach>
					</ul>
				</div>
			...
			<c:forEach items="${books}" var="book">
				<li>
					<div class="c3_b2_txt">
						...
						<p>
							<a href="viewBook?id=${book.id}">更多精彩，点击进入</a>
						</p>
					</div>
				</li>
			</c:forEach>
